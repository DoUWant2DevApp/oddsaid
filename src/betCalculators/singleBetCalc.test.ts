...
test.each([
  ...
  ["6.67", "3/5", "Fractional", 2, { profit: 4.0, totalPayout: 10.67 }],
  ["4.56845", "-333", "American", 2, { profit: 1.37, totalPayout: 5.94 }],
])("singleBet test", (betAmount, odds, oddsFormat, toFixed, correctOutput) => {
  //@ts-ignore
  let res = singleBet(betAmount, odds, oddsFormat, toFixed)
